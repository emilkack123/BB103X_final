...
def process_pdb_files(folders, output_csv):
    ...
    Adds a TYPE column to indicate NATURAL or GENERATED sequences.
    """
    data = {"ID": [], "STABILITY": [], "TYPE": []}
    ...
    for folder in folders:
        ...
        seq_type = "NATURAL" if is_nat else "GENERATED"
...
def main():
    ...
    parser.add_argument("--output", default="results/confidence_scores.csv", 
                        help="Path to save the output CSV file (default: confidence_scores.csv)")
